...
# Load outputs
mmLHS_params_Dolores <- read.csv(paste0(dynamic_input_dir,"/!mmLHS_params.csv"))
...
df_gof <- data.frame(
  Q_Dolores_09165000 = list_data_Dolores$Q$`09165000`$total$NRMSE,
  Q_Dolores_09166500 = list_data_Dolores$Q$`09166500`$total$NRMSE,
  
  SNOTEL_Dolores_465 = list_data_Dolores$SWE$CO$`465`$NRMSE,
  SNOTEL_Dolores_586 = list_data_Dolores$SWE$CO$`586`$NRMSE,
  SNOTEL_Dolores_739 = list_data_Dolores$SWE$CO$`739`$NRMSE,
  SNOTEL_Dolores_1060 = list_data_Dolores$SWE$CO$`1060`$NRMSE,
  SNOTEL_Dolores_1185 = list_data_Dolores$SWE$CO$`1185`$NRMSE,
  
  ASO_Dolores_20220415 = list_data_Dolores$ASO$NRMSE_byflight_AW[,3],
  ASO_Dolores_20220510 = list_data_Dolores$ASO$NRMSE_byflight_AW[,4],
  
  SCA_Dolores = list_data_Dolores$MOD10A1$NRMSE_bybasin,
  
  SMS2_Dolores_586 = list_data_Dolores$SMS2$CO$`586`$NRMSE,
  SMS2_Dolores_1060 = list_data_Dolores$SMS2$CO$`1060`$NRMSE,
  SMS2_Dolores_1185 = list_data_Dolores$SMS2$CO$`1185`$NRMSE,
  
  SMAP_Dolores = list_data_Dolores$SMAPsfwt$NRMSE_bybasin,
  
  AET_Dolores = list_data_Dolores$openet$NRMSE_bybasin
)
...
criteria_names <- list(Q = colnames(df_gof[c(1,2)]), 
                       Q_SNOTEL_465 = colnames(df_gof[c(1,2,3)]), 
                       Q_SNOTEL_586 = colnames(df_gof[c(1,2,4)]),
                       Q_SNOTEL_739 = colnames(df_gof[c(1,2,5)]),
                       Q_SNOTEL_1060 = colnames(df_gof[c(1,2,6)]),
                       Q_SNOTEL_1185 = colnames(df_gof[c(1,2,7)]),
                       Q_ASO_a = colnames(df_gof[c(1,2,8)]), 
                       Q_ASO_b = colnames(df_gof[c(1,2,9)]), 
                       Q_ASO_both = colnames(df_gof[c(1,2,8,9)]),
                       Q_SCA = colnames(df_gof[c(1,2,10)]),
                       Q_SMS2_586 = colnames(df_gof[c(1,2,11)]),
                       Q_SMS2_1060 = colnames(df_gof[c(1,2,12)]),
                       Q_SMS2_1185 = colnames(df_gof[c(1,2,13)]),
                       Q_AET = colnames(df_gof[c(1,2,14)])#,
