...
### the triple pound sign is indicative of code in the inpyb I didn't run
...
nb_output_dir = pl.Path("./SA_temp_out")
...
# LNORTH - Changed this to the domain dir where the climate .nc is copied (from the efault)
cbh_nc_dir = domain_dir / "cbh_files"
...
# LNORTH - cbh files already loaded/created commenting this out
###cbh_files = [
###    domain_dir / "prcp.cbh",
###    domain_dir / "tmax.cbh",
###    domain_dir / "tmin.cbh",
...
###    control = pws.Control.load_prms(domain_dir / "control.control")

# LNORTH - as of version 1.1
control = pws.Control.load_prms(domain_dir / "control.control", warn_unused_options=False)
